    ...
    <>
        <nav className='p-5 bg-[#0d1117] flex justify-between pl-9'>
            ...
            <div className='flex gap-6'>
                ...
                <a className='p-4 relative group ' href='#'>Skills<span className='absolute -bottom-1 left-0 w-0 h-0.5 bg-[#70A9A1] transition-all duration-300 group-hover:w-full'></span></a>
